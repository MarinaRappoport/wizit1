 ...
 */
public class AllReqsAdapter extends BaseAdapter {

    private Context myContext;

    public AllReqsAdapter(Context context) {
        this.myContext = context;
    }

    @Override
    public int getCount() {
        return AllReqsSing.getInstance().getTourFromAllArrayList().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rl = (RelativeLayout) inflater.inflate(R.layout.req_from_all, parent, false);
        ...
        ReqFromAll r = AllReqsSing.getInstance().getTourFromAllArrayList().get(position);
